<!-- Modal -->
    <div class="modal fade" id="mod_add_item"  align="center" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" align="center" >
            <div class="modal-content" >
                    ...
                    <div class="alert alert-info">
                      ...
                      <form class="forms-sample">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select type="text" class="form-control" id="txt_i_category" onchange="selected_category();" >
							<option></option>
							<?php 
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9" id="div_sub_category" >
                            <select type="text" class="form-control" id="txt_i_sub_category" disabled >
							<option></option>
							<?php 
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="txt_item" placeholder="Enter Description">
                          </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="save_tot();" title="Save" ><i class="fa fa-save" ></i> Save</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
